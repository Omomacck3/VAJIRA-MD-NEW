...
global.owner = process.env.OWNER_NUMBER  || '918787651195' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=OI01SSKD#J9rBmI7Z932ThqNxBiICXJpwa6dUbB7mv0zfikloYJ0' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "918787651195" : process.env.MODERATORS ,    
